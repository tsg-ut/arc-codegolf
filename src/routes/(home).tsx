	...
	return (
		<Switch>
			<Match when={!authState.data}>
				<Container class={styles.agreementContainer}>
					<div class={styles.agreementBox}>
						<div class={styles.agreement}>
							<h1>TSG ARC Codegolf</h1>
							<p>
								このサイトは、TSG部員のみがアクセスできるコードゴルフのサイトです。
							</p>
							<p>
								サイトにアクセスするには以下の条項に同意する必要があります。
							</p>
							<ol>
								<li>
									...
									<ul>
										<li>
											なお、提出されたコードを利用して賞金などを獲得した場合、提出者の貢献の割合に応じて賞金を分配することを予定しています。(分配方法は今後決定します)
										</li>
									</ul>
								</li>
								<li>
